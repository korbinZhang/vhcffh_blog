...
description: 本文简明扼要地介绍了信息论中的几个核心基本概念。内容涵盖了信息熵、条件熵、信息增益、基尼系数（基尼不纯度）、信息增益比率、分裂信息、边界熵以及边界多样性（Accessor Variety, AV）的定义和数学公式。这些概念是机器学习，特别是决策树和自然语言处理中进行特征选择和模型评估的基础。
---
