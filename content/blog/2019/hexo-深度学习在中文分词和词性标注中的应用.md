...
description: "本文概述了一种结合深度学习进行中文分词和词性标注的方法。其核心流程是：先将字转换为字向量，通过窗口方法获得包含上下文信息的向量，再经过神经网络层得到每个字的标签得分。模型引入了标签间的转移分数，并使用维特比（Viterbi）算法在全局上寻找最优的标签序列路径，通过最大化对数似然函数进行端到端的训练。"
---
