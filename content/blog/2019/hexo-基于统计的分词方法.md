...
description: 本文主要介绍了基于统计的中文分词方法。首先讲解了N-gram语言模型（一元、二元、三元）的基本原理。接着，重点阐述了隐马尔可夫模型（HMM）在分词中的应用，详细定义了HMM的五个核心参数，并概述了其三大基本问题：概率计算、学习问题和解码问题，以及对应的算法（前向后向、鲍姆-韦尔奇、维特比），最后还对比了HMM、MEMM和CRF模型的特点。
---
