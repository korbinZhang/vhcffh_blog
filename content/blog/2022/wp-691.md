---
date: 2022-02-05
tags: ["C", "Data Structure", "Red-Black Tree"]
description: "本文详细介绍了红黑树的C语言实现。内容涵盖了红黑树的节点结构定义，以及创建、销毁、左旋、右旋、插入和删除等核心操作。文章对插入和删除后用于维持红黑树性质的修正（fixup）过程，根据不同情况进行了分类讨论，并提供了相应的代码实现。"
---
