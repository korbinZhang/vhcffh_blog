---
date: 2022-03-12
tags: ["Algorithm", "SAT", "DPLL"]
description: "本文介绍了布尔可满足性（SAT）问题中的合取范式（CNF）和求解该问题的DPLL算法。内容首先解释了CNF的定义，然后通过四个步骤详细说明了如何将任意逻辑表达式转换为CNF。最后，概述了基于回溯搜索的DPLL算法如何解决CNF-SAT问题。"
---
