---
date: 2020-07-21
tags: ["Kafka", "Confluent", "Zookeeper"]
description: 本文介绍了Confluent平台系列软件。内容涵盖了Zookeeper、Kafka、Schema Registry、Kafka-Rest、Connect、ksql-server和Control-center等核心组件的功能和作用，并解释了它们如何协同工作。最后还提供了在本地环境中一键启动和关闭整个Confluent平台的命令。
---
