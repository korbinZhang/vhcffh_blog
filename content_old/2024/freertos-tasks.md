---
date: 2024-04-19T08:15:06.770Z
updated: 2024-05-09T14:23:45.723Z
title: FreeRTOS的任务
slug: freertos-tasks
oid: 6622280ac22c090a81d74e7d
categories: 系统
type: post
permalink: /posts/系统/freertos-tasks
---
...
- 挂起
	与"阻塞"状态下的任务一样，"挂起"状态下的任务不能被选择进入运行状态，但处于挂起状态的任务没有超时。相反，任务只有在分别通过 `vTaskSuspend()`和`xTaskResume()`API调用明确命令时才会进入或退出挂起状态。
