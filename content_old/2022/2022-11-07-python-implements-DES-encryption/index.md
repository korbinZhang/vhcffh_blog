...
[extra]
toc = true
keywords = "DES, 加密, python"
+++

# DES算法原理

DES算法是一种最通用的对称密钥算法，因为算法本身是公开的，所以其安全性取决于密钥的安全性。
...
1. [des加密python源码](https://github.com/FreyZhang007/python-encrypt/blob/93090b37a92005781c01bf21921c632e35f50254/des.py)
2. [DES算法实例详解](http://www.hankcs.com/security/des-algorithm-illustrated.html)
